...
namespace HomeWork10
{
    public partial class AddPro : Form
    {
        ...
        public String newTypeOfProduct;
        public double newPriceOfProduct;
        public int newAmountOfProduct;
        public void init()
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                newTypeOfProduct = ProName;
                newPriceOfProduct = double.Parse(ProPrice);
                newAmountOfProduct = int.Parse(ProAmount);
                success = true;
            }
            catch (Exception eIn)
            {
