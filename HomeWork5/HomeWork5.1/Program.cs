...
namespace HomeWork5._1
{
    ...
    public class OrderService
    {
        ...
        //查询大于10000的订单
        private void SearchMoreThan(List<Order> allOrder,double TargetMoney)
        {
            List<Order> result = new List<Order>();
        ...
        {
            Console.WriteLine("选择您要进行的服务: 1.添加订单； 2.查询订单；3.打印全部订单； 4.打印金额大于10000的订单； 5.退出");
            int whichFunction = 0;
            while (whichFunction == 0)
            {
                try
                {
                    ...
                    if (whichFunction < 1 || whichFunction > 5) throw new System.FormatException();
                }
                catch (System.FormatException e)
                {
                    whichFunction = 0;
            ...
            switch (whichFunction)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    SearchMoreThan(ListOfOrder, 10000);
                    break;
                case 5:
                    return;
                default:
